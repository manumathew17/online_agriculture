...
<a href="file:///C:/Users/manumathew/Desktop/miniproject.html">
<img border="0" alt="logo" src="C:\Users\manumathew\Desktop\miniproject\images\projectlogo.png" width="77" height="76">
</a>
...
<button class="top-button-design"onclick="document.getElementById('id01').style.display='block'" style="width:auto;">LOGIN</button>
 ...
 <img src="C:\Users\manumathew\Desktop\miniproject\images\introimage.jpg" width="100%">
 <div class="overlay">
    <div class="text">
	 <h2 id="para"></h2>
	 <h5 id="bara"></h5>
  ...
  <td>
  <div class="polaroid">
   <img src="C:\Users\manumathew\Desktop\miniproject\images\flowers.jpg"height="200px" width="100%" >
...
<td>
  <div class="polaroid">
   <img src="C:\Users\manumathew\Desktop\miniproject\images\veg.jpg"height="200px" width="100%" >
  <div class="discription">
  <p>VEGITABLE</p>
  </div>
</div>
...
<td>
  <div class="polaroid">
   <img src="C:\Users\manumathew\Desktop\miniproject\images\fruits.jpeg"height="200px" width="100%" >
  <div class="discription">
  <p>FRUITS</p>
  </div>
</div>
...
<td>
  <div class="polaroid">
   <img src="C:\Users\manumathew\Desktop\miniproject\images\milkproduct.jpg"height="200px" width="100%" >
  <div class="discription">
  <p>MILK PRODUCTS</p>
  </div>
</div>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" method="POST" action="http://localhost/miniproject/online-shopping-webvsite-in-php-master/user_registration_script.php">

    <div class="imgcontainer">
      <span onclick="document.getElementById('id01').style.display='none'" class="close" >&times;</span>
      <img src="C:\Users\manumathew\Desktop\miniproject\images\projectlogo.png" alt="Avatar" class="avatar">
    </div>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" method="POST" action="http://localhost/miniproject/online-shopping-webvsite-in-php-master/login_submit.php">
    ...
    <div class="container" style="background-color:#00bfa5">
      ...
      <button type="button" class="farmerloginbtn">farmer login</button>
	  </center>
